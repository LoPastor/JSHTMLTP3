...
if (this.page==0){
    ...
    let id = form.id.value; // on peut aller chercher la valeur
    ...
    .then(function(responseJSON) {
        ...
        .catch(function (err) {
           ...
           dernierePage(){
            ...
            PreModifier(index){
                // on va chercher tous les éléments du tableau pour les modifier
                document.getElementByName("_id").value=document.getElementById("dataTable").value[index,0];
                document.getElementByName("NomMod").value=document.getElementById("dataTable").value[index,1];
                 document.getElementByName("CuisMod").value=document.getElementById("dataTable").value[index,2];
},
getColor(index) {
